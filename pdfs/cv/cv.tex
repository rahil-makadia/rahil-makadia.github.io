...
Visiting Technologist \hfill 05/23 - 08/23, 03/24 - 06/24, 09/25 - 12/25\\
...
\begin{list_new}
    ...
    \item Upgraded Scout, the short-term impact monitoring system for newly discovered near-Earth objects.
\end{list_new}
...
\begin{list_new}
    ...
    \item Utilized this library to study the orbit of the then-newly discovered interstellar object 3I/ATLAS (C/2025 N1).
\end{list_new}
...
\section{\sc Skills}
{\bf Programming Languages:} Fortran, Perl, Python, C/C++, MATLAB, SQL, R
