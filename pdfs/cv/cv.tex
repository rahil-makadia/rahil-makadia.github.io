    ...
    \multicolumn{2}{@{}X@{}}{
        \begin{minipage}[t]{\linewidth}
            \begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=3pt]
                ...
                \item[--] Implemented a MATLAB analysis pipeline to perform parameter sweeps for varying trajectories and vehicle configurations, and assessed performance of blunt-body vehicles and waveriders.
            \end{itemize}
        \end{minipage}
    }
\end{tabularx}
