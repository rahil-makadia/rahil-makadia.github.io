...
\begin{list_new}
    ...
    \item Released a publicly available Python package, \href{https://rahil-makadia.github.io/grss/}{\textsc{grss}}, to allow the planetary defense scientific community to to study solar system objects.
\end{list_new}
