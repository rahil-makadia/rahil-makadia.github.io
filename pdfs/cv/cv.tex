...
\fancypagestyle{last-page}{
  \fancyhf{} % No header/footer
  % red text
  \fancyfoot[C]{\textcolor{Black!60}{Last updated: \today}} % Centre footer
...
\textbf{NASA Jet Propulsion Laboratory (JPL)} & \hfill Advisors: Dr. Steven Chesley, Dr. Davide Farnocchia \\[3.75pt]
Visiting Technologist / NSTGRO Fellow & \hfill May 2023 - Aug 2023, Mar 2024 - Jun 2024 \\[3.75pt]
    \multicolumn{2}{@{}X@{}}{
...
\begin{tabularx}{\linewidth}{ @{}l r@{} }
\textbf{NASA Goddard Space Flight Center (GSFC)} & \hfill Advisors: Kenneth Getzandanner, Andrew Liounis \\[3.75pt]
OSIRIS-REx/OSIRIS-APEX CelNav Intern & \hfill Jun 2022 - Aug 2022 \\[3.75pt]
    \multicolumn{2}{@{}X@{}}{
        \begin{minipage}[t]{\linewidth}
            \begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=3pt]
                \item[--] Developed simulations to assess performance of Celestial Navigation (CelNav) using onboard optical instruments during the OSIRIS-APEX cruise phase.
                \item[--] Simulated more than 8,000 solar system bodies to obtain optimal observable clusters for the spacecraft.
                \item[--] Performed covariance analysis using JPL's MONTE software to study the spacecraft's state uncertainty on its way to asteroid (99942) Apophis.
            \end{itemize}
        \end{minipage}
    }
\end{tabularx}
...
Gauss-Radau Small-body Simulator (\textsc{grss}) & \hfill Nov 2022 - present \\[3.75pt]
\multicolumn{2}{@{}X@{}}{
    \begin{minipage}[t]{\linewidth}
        \begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=3pt]
...
\begin{tabularx}{\linewidth}{ @{}l r@{} }
Double Asteroid Redirection Test (DART) Mission & \hfill May 2020 - Feb 2024 \\[3.75pt]
\multicolumn{2}{@{}X@{}}{
    \begin{minipage}[t]{\linewidth}
        \begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=3pt]
