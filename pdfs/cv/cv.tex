...
\fancypagestyle{firstpage}{
    ...
    \lhead{
        \hspace{\myspacing} 104 S Wright St\\
        \hspace{\myspacing} 307 Talbot Laboratory\\
        \hspace{\myspacing} Urbana, IL 61801
    } % Left header
    \rhead{
        \ifphone
        \input{phone.num}\\
        \fi
        \href{mailto:makadia2.uiuc@gmail.com}{makadia2.uiuc@gmail.com}\\
        \href{https://rahil-makadia.github.io/}{rahil-makadia.github.io}
    }
}
...
Visiting Technologist \hfill 09/25 - 12/25, 03/24 - 06/24, 05/23 - 08/23\\
Advisors: Steven Chesley, Davide Farnocchia
\begin{list_new}
    \item Upgraded JPL's Scout, the short-term impact monitoring system for newly discovered near-Earth objects, making the system 300\% faster.
    \item Implemented a novel adaptive method to perform initial orbit determination of solar system objects.
    \item Produced ability to compute locations of gravitational keyholes, which are predictors of future asteroid impacts with Earth.
    \item Wrote an efficient orbit propagator with sub\,-1\,km position accuracy over 250 years compared to JPL's orbit software.
    ...
    \item Released a publicly available Python package, \href{https://rahil-makadia.github.io/grss/}{\textsc{grss}}, to allow the planetary defense scientific community to study solar system objects.
\end{list_new}
...
\begin{list_new}
    \item Analyzed high-fidelity ejecta dynamics simulation results from JPL for impacts in the (65803) Didymos binary asteroid system.
    ...
    \item Leveraged ultra-precision occultation measurements in 2024 and 2025 to detect heliocentric changes in an asteroid's orbit for the first time in human history.
\end{list_new}
...
\end{list_new}
\href{https://rahil-makadia.github.io/grss/}{Gauss-Radau Small-body Simulator (\textsc{grss})}
\begin{list_new}
    ...
    \item Utilized this library to study the orbit of the newly discovered interstellar object 3I/ATLAS (C/2025 N1).
\end{list_new}
...
\section{\sc Skills}
{\bf Programming Languages:} Fortran, Python, C/C++, MATLAB, Perl, SQL, R
...
\csuse{entrycount:3} Invited Seminars and Talks
