    ...
    \multicolumn{2}{@{}X@{}}{
        \begin{minipage}[t]{\linewidth}
            \begin{itemize}[nosep,after=\strut, leftmargin=1em, itemsep=3pt]
                \item[--] Created an efficient solar system propagator with sub-kilometer position accuracy over 250 years compared to solutions from NASA's Jet Propulsion Laboratory (JPL).
