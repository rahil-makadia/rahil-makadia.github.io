...
\renewcommand{\mkbibnamefamily}[1]{%
    % if last name is Makadia or first name is Rahil, make it bold
    \ifboolexpr{test {\ifdefstring{\namepartfamily}{Makadia}} and test {\ifdefstring{\namepartgiven}{Rahil}}}
    {\textbf{#1}}
    {#1}
}
% first name
...
\ifphone
\hspace{\myspacing}\huge{\bf Rahil Makadia} \hfill \large{Cell: \input{phone.num}}
\else
...
\csuse{entrycount:3} Invited Public Talks and Seminars
